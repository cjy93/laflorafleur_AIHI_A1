...
dsn_port = str(credentials1['connection']['db2']['hosts'][0]['port'])
...
dsn = (
    ...
    "UID={3};"
    "PWD={4};"
    "SECURITY={5};").format(dsn_database, dsn_hostname, dsn_port, dsn_uid, dsn_pwd, dsn_ssl)
try:
...
def test():
    ...
    try:
        payload = {
            ...
            "generic": message['output']['generic']
        }
    except:
        payload = {
            "generic": message['output']['generic']
